...
#ifndef QEXTSCINTILLALEXERHTML_H
#define QEXTSCINTILLALEXERHTML_H
...
//! lexer.
class QEXTSCINTILLA_EXPORT QextScintillaLexerHTML : public QextScintillaLexer
{
	Q_OBJECT
...
public:
	...
	QextScintillaLexerHTML(QObject *parent = 0,const char *name = 0);
	...
	//! \internal Returns the number of style bits needed by this lexer.
	int styleBits() const;
